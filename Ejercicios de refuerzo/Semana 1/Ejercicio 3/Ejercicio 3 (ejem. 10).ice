    ...
    "graph": {
      "blocks": [
        ...
        },
        {
          ...
          "type": "basic.info",
          "data": {
            "info": "Elemento de control del display\n",
            "readonly": true
          },
          "position": {
            "x": 1048,
        ...
        },
        {
          ...
          "type": "basic.info",
          "data": {
            "info": "Reloj para definir el tiempo de pitido del timbre. \n",
            "readonly": true
          },
          "position": {
            "x": 512,
        ...
        },
        {
          ...
          "type": "basic.info",
          "data": {
            "info": "Elemento que usamos para generar pulsos a una frecuencia específica.",
            "readonly": true
          },
          "position": {
            "x": 512,
        ...
        },
        {
          ...
          "type": "basic.info",
          "data": {
            "info": "Esta vez se supone que tenemos un detector de objetos (sustituido con un pulsador) el cual le manda los pulsos a un contador el cual lleva la cuenta de los objetos que han pasado. Además, tenemos un elemento para retener el pulso y dos elementos que junto a una puerta and activan el timbre.",
            "readonly": true
          },
          "position": {
            "x": 176,
        ...
        },
        {
          ...
          "type": "basic.info",
          "data": {
            "info": "Usamos este LED para representar visualmente que hemos \"detectado un objeto\" (usado el pulsador)\n",
            "readonly": true
          },
          "position": {
            "x": 976,
        ...
        },
        {
          ...
          "type": "basic.info",
          "data": {
            "info": "elemento para retener el pulso",
            "readonly": true
          },
          "position": {
            "x": 280,
        ...
        {
          "id": "eadf4d57-f180-431b-948a-17f66cd3d8f2",
          "type": "basic.info",
          "data": {
            "info": "Salidas del display",
            "readonly": true
          },
          "position": {
            "x": 1344,
        ...
        {
          "id": "5be74dea-f404-4245-96d7-df7589fbea15",
          "type": "basic.info",
          "data": {
            "info": "Salida del timbre\n",
            "readonly": true
          },
          "position": {
            "x": 984,
        ...
        {
          "id": "f15f65cc-9006-434f-9b06-566b3585525d",
          "type": "basic.info",
          "data": {
            "info": "Puerta and para que el timbre suene solo cuando el reloj nos de un pulso",
            "readonly": true
          },
          "position": {
            "x": 712,
