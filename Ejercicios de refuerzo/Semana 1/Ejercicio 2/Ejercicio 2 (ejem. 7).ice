  ...
  "design": {
    ...
    "graph": {
      "blocks": [
        ...
        {
          "id": "ed506947-b17c-45f9-bf4c-a2669ecfca1b",
          "type": "basic.info",
          "data": {
            "info": "Salidas, 7 (D0-D6) para los pines del Display, y 2 (LED0 y LED1) para la cuenta en binario del contador 2.\n",
            "readonly": true
          },
          "position": {
            "x": 864,
        ...
        {
          "id": "220e3c86-4308-4312-b73e-ebcda64a87de",
          "type": "basic.info",
          "data": {
            "info": "Elemento de programación del Display.",
            "readonly": true
          },
          "position": {
            "x": 552,
        ...
        {
          "id": "bd6cd6af-6e75-4851-b6b5-064070831237",
          "type": "basic.info",
          "data": {
            "info": "Contadores:\n- Contador 1: Cuenta cada vez que usemos el pulsador, desde 0 hasta 3. La cuenta se muestra en binario.\n- Contador 2: Cuenta las veces que el contador 2 ha llegado hasta 0 tras haber llegado a 3 (cada 4 pulsaciones)\n",
            "readonly": true
          },
          "position": {
            "x": 424,
        ...
        {
          "id": "ac465561-2bbe-41c2-85eb-44d71091c3ec",
          "type": "basic.info",
          "data": {
            "info": "Contador 1",
            "readonly": true
        ...
        {
          "id": "138c1218-0185-4765-a3ca-1078e1412512",
          "type": "basic.info",
          "data": {
            "info": "Contador 2",
            "readonly": true
        ...
        {
          "id": "4edeb6f7-7ed5-49b8-a2e3-d7d2da33f505",
          "type": "basic.info",
          "data": {
            "info": "Las entradas, al igual que antes, son los pulsadores de la Alhambra II.",
            "readonly": true
          },
          "position": {
            "x": 40,
        ...
        {
          "id": "59af3f3f-ff87-489d-8c78-5f6fb4c63343",
          "type": "basic.info",
          "data": {
            "info": "Como en el anterior ejercicio este elemento se encarga de retener el pulso del pulsador.",
            "readonly": true
          },
          "position": {
            "x": 168,
        ...
        {
          "id": "688b29dd-42e0-4c70-a07d-eb44715c39bc",
          "type": "basic.info",
          "data": {
            "info": "Este ejercicio consiste en un contador contando las pulsaciones de un pulsador y otro contador contando las veces que el primer contador realiza un ciclo completo (en nuestro caso llegar hasta 3)",
            "readonly": true
          },
          "position": {
            "x": 88,
