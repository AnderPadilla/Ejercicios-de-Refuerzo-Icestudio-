  ...
  "design": {
    ...
    "graph": {
      "blocks": [
        ...
        {
          "id": "3482b4b5-4697-4a16-a67d-2d535a1c80b2",
          "type": "basic.info",
          "data": {
            "info": "Con este elemento hacemos que cada vez que reciba un pulso, pase a la posición que nos de el contador en la taba \"SECUENCIA\" y a su vez mandando esa información a los LEDs de salida.",
            "readonly": false
          },
          "position": {
            "x": 544,
        ...
        {
          "id": "6baf8414-e876-4fe4-a3ec-2057fb135677",
          "type": "basic.info",
          "data": {
            "info": "Salida de los LEDs.",
            "readonly": true
          },
          "position": {
            "x": 904,
        ...
        {
          "id": "def9731b-9191-47ad-81c2-a5e481e96d4c",
          "type": "basic.info",
          "data": {
            "info": "Usamos esta tabla para decirle al elemento al que está unida la información de los LEDs, es decir, en está tabla elegimos cómo queremos que se enciendan los LEDs en cada posición.\n",
            "readonly": true
          },
          "position": {
            "x": 528,
        ...
        {
          "id": "aa462bae-5a59-46ee-84e1-0e90cbd6441d",
          "type": "basic.info",
          "data": {
            "info": "Este elemento manda un 0 a la entrada reset del contador.\n",
            "readonly": true
          },
          "position": {
            "x": 144,
        ...
        {
          "id": "4110bbae-56e5-4c73-931c-af3824dab174",
          "type": "basic.info",
          "data": {
            "info": "Número que indica la cantidad de posiciones de la secucencia.\n",
            "readonly": true
          },
          "position": {
            "x": 352,
        ...
        {
          "id": "53733051-a8fb-4a94-b757-15bf4eb50f81",
          "type": "basic.info",
          "data": {
            "info": "Elemento para mandar pulsos (en este caso cada 50ms).",
            "readonly": true
          },
          "position": {
            "x": 112,
        ...
        {
          "id": "90e23fd8-14d6-462b-b6e2-9d2896081605",
          "type": "basic.info",
          "data": {
            "info": "Contador.",
            "readonly": true
        ...
        {
          "id": "02bc081f-90d5-4d8a-92cf-e738f62a102c",
          "type": "basic.info",
          "data": {
            "info": "En este programa creamos una secuencia para mostrarla en los LEDs de la propia Alhambra II. En este caso hacemos la secuencia en una tabla, la cuál interpretamos con un elemento que cuando reciba una posición del contador se colocará en la misma mandando la información de la posición a los LEDs.",
            "readonly": true
          },
          "position": {
            "x": 104,
